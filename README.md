...
Extracción mediante un script en Python ejecutado en Databricks, guardando la respuesta JSON cruda junto con marcas de tiempo (ingestion_timestamp) en una tabla Delta Lake.
